...
public class CardanoClientLibConfig {
    ...
    public Account ownerAccount(CardanoNetwork cardanoNetwork,
                                @Value("${lob.owner.account.mnemonic:test test test test test test test test test test test test test test test test test test test test test test test sauce}" ) String lobOwnerMnemonics) {
