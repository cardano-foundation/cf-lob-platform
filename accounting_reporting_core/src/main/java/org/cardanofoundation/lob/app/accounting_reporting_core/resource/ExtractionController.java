...
public class ExtractionController {
    ...
    public ResponseEntity approveTransactionsPublish(@Valid @RequestBody ExtractionTransactionsRequest transactionsRequest) {
        return ResponseEntity
                .ok()
                .body(extractionItemService.findTransactionItems(transactionsRequest.getAccountCode()));
    }
