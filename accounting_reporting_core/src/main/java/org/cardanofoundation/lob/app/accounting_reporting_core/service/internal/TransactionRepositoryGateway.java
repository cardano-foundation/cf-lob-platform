...
public class TransactionRepositoryGateway {
    ...
    public List<TransactionEntity> findReconciliation(ReconciliationFilterRequest body) {
        return accountingCoreTransactionRepository.findAllReconciliation(body);
    }

    public List<Object[]> findReconciliationSpecial( ReconciliationFilterRequest body) {
        return accountingCoreTransactionRepository.findAllReconciliationSpecial(body);
    }

    public List<Object[]> findReconciliationSpecialCount(ReconciliationFilterRequest body) {
        return accountingCoreTransactionRepository.findAllReconciliationSpecialCount(body);
    }

    public Object[] findReconciliationStatistic() {
        return accountingCoreTransactionRepository.findCalcReconciliationStatistic();
    }
